	...
	$form =
		...
		sprintf(
			'<p class="login-username">
				...
				<input type="text" name="log" id="%1$s" class="input-md round form-control" placeholder="Enter your username" value="%3$s" size="20" />
			</p>',
		...
		sprintf(
			'<p class="login-password">
				<label for="%1$s">%2$s</label>
				<input type="password" name="pwd" id="%1$s" class="input-md round form-control" placeholder="Enter your password" value="" size="20" />
			</p>',
		...
		sprintf(
			'<p class="login-submit">
				<input type="submit" name="wp-submit" id="%1$s" class="submit_btn btn btn-mod btn-medium btn-round btn-full" value="%2$s" />
